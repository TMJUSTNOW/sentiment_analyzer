...
## Stop Words
stop_words = ['after', 'others', 'clud', 'would', 'id', 'self', 'youll', 'hundred','quarter', 'billion', 'brother', 'second', 'shes','yet','bit', 'break','shop','suppose','sell','holiday',
              'becomes', 'youd', 'etc', 'college', 'shin', 'server', 'uni', 'jordanknight', 'swine', 'adam', 'clean','anyway','sometimes', 'scanner', 'millisecond',
              'prom', 'england', 'bath', 'battery', 'button', 'plz', 'freakin', 'click', 'addict', 'topic', 'code','puppy', 'app', 'freak', 'random', 'ball', 'heard', 'mile', 'plane', 'revision', 'sat', 'kiss', 'arm', 'ear', 'indeed', 'tan', 'state', 'hmmm', 'group', 'longer', 'vip', 'mommy', 'promise', 'completely', 'fire', 'co', 'sale', 'hotel', 'wash', 'web', 'lakers', 'dark', 'currently', 'ruin', 'lately', 'ohh', 'ff', 'hun', 'left', 'deserve', 'stuck', 'huh', 'track', 'lost', 'buddy', 'profile', 'quick', 'bloody', 'fucking', 'surprise',
              ...
              'size', 'oooh', 'charge', 'disney', 'guys', 'xbox', 'mind', 'link', 'course','hair', 'wife', 'eye', 'thats', 'come', 'plot',
              'english', 'so', 'house', 'year','stick','nap', 'sigh', 'ride', 'dress', 'sing', 'tea', 'account', 'realize', 'park', 'decide', 'understand', 'order', 'nd', 'cream', 'less', 'chat','way','thank','spend','fly', 'try', 'baby', 'finish','already', 'call','eat', 'follow', 'play', 'men', 'take', 'cooky', 'gunna', 'wall', 'tree', 'client',
              'essay', 'sushi', 'germany', 'twice','list', 'be', 'jon', 'loud', 'fav', 'danny', 'boat', 'style', 'mention', 'camp', 'except', 'near', 'hospital', 'lets', 'radio', 'fight', 'fact', 'lonely', 'looks', 'taste', 'issue', 'storm', 'scary', 'wine',
              ...
              'gutted', 'ima', 'present', 'airport','computer','half','hello', 'able','room','chance', 'throat','pool','band','probably', 'bring', 'anyone', 'babe','lunch', 'food','cry','whats', 'seem', 'update', 'meet', 'forget', 'uh', 'woohoo', 'mama', 'local', 'jack',
              'student', 'smoke', 'brazil', 'york','everything', 'taking', 'couch','green', 'mitchelmusso', 'file','flight', 'comment', 'kick', 'sunshine', 'beat', 'butt', 'alive', 'imma','bff', 'texas', 'morrow', 'pant', 'law', 'cloud', 'desk',
              'personal', 'kitchen', 'hes', 'west', 'push', 'king', 'training','warm', 'huge', 'bet','paper', 'card', 'burn', 'load', 'cook', 'rather', 'evening', 'moon', 'apparently','ate', 'boys', 'wii', 'strange','credit', 'mi', 'girls', 'strawberry', 'control', 'grade', 'talent', 'anytime', 'forgot','burnt', 'brothers', 'connect', 'accident',
              'taylorswift', 'switch', 'mo', 'made', 'canada', 'jb', 'facebook', 'twitter', 'mornin', 'fry','bus','holding', 'cake','blue', 'white', 'age', 'throw', 'plus', 'nope', 'small', 'looking', 'forever','trying','vacation', 'beer', 'upload', 'listening', 'mess', 'working', 'light', 'day', 'channel', 'bird','cleaning', 'cell', 'wheres', 'schedule', 'jump', 'msn', 'folk', 'article', 'milk', 'imagine', 'key', 'darn', 'dnt', 'san', 'nervous', 'making', 'knee', 'clear', 'everyday', 'crack', 'anywhere', 'afford', 'consider', 'floor', 'however', 'somebody', 'expensive', 'secret', 'drag', 'draw', 'quote', 'lake', 'chip', 'unless', 'strong', 'delicious', 'row', 'system', 'crappy', 'workout', 'create',
              ...
              'world', 'could', 'yourselves', 'text', 'august', 'energy', 'ad', 'egg', 'tonite', 'narrative', 'point','appreciate', 'speak', 'cover', 'shout', 'trailer', 'thru', 'peep', 'wet', 'celebrate', 'offer', 'copy', 'trek', 'exhaust', 'friends', 'straight', 'confuse', 'shift', 'badly', 'contact', 'woke', 'honey', 'screw', 'drinking', 'epic', 'spot', 'tune', 'graduate', 'gift', 'jk', 'australia', 'price', 'board', 'south', 'hahahaha', 'fresh', 'match', 'prob', 'bunch', 'cough', 'laundry', 'color', 'afraid', 'degree', 'include', 'feelin', 'anyways', 'sum', 'broken','mix', 'living', 'prepare', 'dry','orange', 'attend', 'boston', 'daily',
              ...
              'jon', 'series', 'store', 'actually', 'years', 'man', 'im', 'with', 'only', 'is', 'had','rd', 'shut', 'fever', 'delete', 'silly', 'info', 'blow', 'ring', 'went', 'magic', 'brain', 'lesson', 'none', 'manage', 'background', 'possible', 'doubt', 'missing', 'land', 'interest', 'sitting', 'nail', 'bite', 'mark', 'doin', 'normal', 'starbucks', 'rid', 'middle',
              'll', 'into', 'being', 'a', 'ohhh', 'me', 'seem', 'has', 'mine', 'ask', 'age', 'dinner', 'limited', 'been', 'why', 'flat', 'connection', 'apartment', 'market', 'perhaps', 'slept', 'rule','goodness', 'total', 'um', 'paris', 'bgt', 'h', 'festival', 'shake', 'woot', 'dc', 'skin',
              ...
              'outta', 'bother', 'dentist', 'corporate', 'investor', 'session', 'pack', 'themselves', 'chicago', 'donniewahlberg', 'while', 'we','africa', 'sm', 'injury', 'necklace', 'remote', 'lens', 'indoors', 'amen', 'sd', 'device', 'bound', 'sofa',
              'against', 'further','sydney', 'musk','conan','sleeping', 'dave','soul','grab', 'recently', 'tennis', 'software', 'makes', 'wide', 'remove', 'enter', 'replace', 'awe'
              'these', 'those', 'were', 'be','pd', 'tn', 'turn', 'station', 'midnight', 'him', 'cuz','hardcore', 'sorta', 'extreme', 'arse', 'mario', 'relieve', 'coverage', 'phoenix', 'linux', 'purpose', 'therapy', 'sonic', 'legal', 'safely', 'dizzy', 'simon', 'introduce', 'karma', 'halo', 'rabbit', 'cheesecake', 'buying', 'snl', 'phil', 'distance', 'signing', 'nigga',
              ...
              'city', 'soooo', 'nite', 'xd', 'ice', 'bout', 'it', 'did', 'june', 'cat', 'afternoon', 'tommcfly', 'hop','gnight','britney', 'bay', 'suit', 'queen', 'avatar', 'exercise',
              'lmao', 'himself', 'facebook', 'aw', 'fix', 'asleep', 'her', 'such', 'have', 'yours', 'more', 'for','things', 'gear', 'infection', 'msg', 'palm', 'noise', 'several', 'geek', 'wild', 'exist', 'spain', 'iron', 'bomb', 'zoo', 'toronto', 'suddenly', 'umm', 'bean', 'took', 'steve', 'per', 'buck', 'river', 'stock', 'headed', 'whoa', 'skype',
              ...
              'train', 'til', 'ticket', 'facebooks','pic', 'study', 'damn','corporation', 'morning', 'tonight', 'subscriber','shares', 'industry', 'corp','thing', 'twitter', 'haha','patch', 'laurenconrad', 'hahahahaha', 'volunteer','string', 'stephen', 'vancouver', 'ant', 'kit', 'prop', 'salt', 'bash', 'listenin', 'sending', 'ako', 'port', 'gm', 'shud', 'cs', 'wt', 'restore', 'castle', 'circle', 'fridays', 'arse'
              'tomorrow', 'does', 'was', 'its', 'below', 'hers', 'yourself', 'inc']
movie_stop_words = ['actors', 'actor', 'idea', 'ca', 'provide', 'old', 'timeless','goood', 'cultural', 'collection', 'target',
                    ...
                    'monday', 'think', 'cinematography', 'father', 'say','says',
                    ...
                    'writerdirector', 'oldfashioned', 'character', 'oscar', 'adaptation', 'tv', 'main', 'sense',
                    'woman', 'girl', 'middle',
                    ...
                    'manner', 'amateurish', 'brown', 'book', 'rhythm', 'exactly', 'mak', 'cut', 'artist', 'image',
                     'question', 'director', 'ive', 'back', 'th', 'chemistry', 'bill', 'lee',
                    ...
                    'br', 'dialog', 'james', 'one', 'whimsical', 'odd', 'tear', 'guarantee',
...
def predict_sentiment(model, clean_string_list, start=0):
    ...
    for index, clean_string in enumerate(clean_string_list):
        ...
        for word, typ in nltk.pos_tag(word_tokenize(clean_string)):
            ...
            if lemmatized_word in stop_words+movie_stop_words or (not enchant_dict.check(lemmatized_word)):
                # Removing all stop words and Noun phrases from testing
                # print('Word in stop word or noun {0}=== type {1}'.format(word, typ))
                continue

            try:
                input_data[index, n_words] = word_vectors[lemmatized_word]
                n_words += 1
...
def load_vocab():
    ...
    with open('/home/john/sentiment_files/Model_and_data/Model_Aug19/complete_vocab_15_word2.pkl', 'rb') as f:
        data = pickle.load(f)
