...
print(imdb_vocab_frequency[:1000])
...
print('IMDB len of vocab tuple ', len(twitter_vocab_frequency))
print(imdb_vocab_frequency[:2000])

complete_vocab = [(val,freq) for val,freq in rotten_vocab_frequency_tuple[:1000] if val not in stop_words]
word_list = list(zip(*complete_vocab))[0]

for val, freq in imdb_vocab_frequency:
...
with open('/home/janmejaya/sentiment_files/data/complete_vocab.pkl', 'wb') as f:
