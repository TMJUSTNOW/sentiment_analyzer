...
sess.close()
model.fit(input_data, target, batch_size=batch_size, epochs=3, validation_split=0.3, verbose=2)


print('Testing file...')
with open('/home/john/sentiment_files/data/complete_data_15_word/Test/complete_test.pkl', 'rb') as f:
    data = pickle.load(f)
