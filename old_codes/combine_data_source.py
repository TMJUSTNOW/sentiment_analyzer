...
stop_words = ['after', 'others', 'clud', 'would', 'id', 'self', 'youll', 'brother', 'second', 'shes','yet','bit', 'break','shop','suppose','sell','holiday',
              ...
              'prom', 'england', 'bath', 'battery', 'button', 'plz', 'freakin', 'click', 'addict', 'topic', 'code','puppy', 'app','random', 'ball', 'heard', 'mile', 'plane', 'revision', 'sat', 'ahead', 'kiss', 'arm', 'ear', 'indeed', 'tan', 'state', 'hmmm', 'group', 'longer', 'vip', 'mommy', 'fire', 'co', 'sale', 'hotel', 'wash', 'web', 'lakers', 'dark', 'currently', 'ruin', 'lately', 'ohh', 'ff', 'hun', 'left', 'huh', 'track', 'buddy', 'profile', 'bloody', 'fucking',
              ...
              'english', 'so', 'house', 'year','stick','nap', 'sigh', 'ride', 'dress', 'sing', 'tea', 'fast', 'account', 'realize', 'park', 'decide', 'understand', 'order', 'nd', 'cream', 'less', 'chat','way','spend','fly', 'try', 'baby', 'already', 'call','eat', 'follow', 'play', 'men', 'take', 'cooky', 'gunna', 'wall', 'tree', 'client',
              'essay', 'sushi', 'germany', 'twice','list', 'be', 'jon', 'loud', 'fav', 'danny', 'boat', 'style', 'mention', 'camp', 'except', 'chill', 'block', 'near', 'hospital', 'lets', 'radio', 'fight', 'lie', 'gorgeous', 'looks', 'alright', 'taste', 'issue', 'storm', 'scary', 'wine',
              'girlfriend', 'vid', 'spring', 'jam','hit','reply', 'close', 'remember', 'soup', 'line', 'put','lines', 'direct', 'three', 'couple', 'next','pray', 'glass', 'waiting', 'count', 'arrive', 'bag', 'bar', 'invite', 'mothers', 'pull', 'sounds', 'reading', 'remind', 'along', 'round', 'matter', 'although', 'swim', 'guitar', 'mate', 'joke', 'return', 'low', 'single', 'hangover', 'everybody', 'door', 'hahah', 'bb',
              'home', 'else', 'saw', 'work','check', 'foot','may', 'birthday','bottle', 'machine', 'sunburn', 'mmm', 'grad', 'mmm', 'available',
              ...
              'taylorswift', 'switch', 'mo', 'made', 'canada', 'jb', 'mornin', 'fry','bus', 'cake','blue', 'white', 'age', 'throw', 'plus', 'nope', 'small', 'looking', 'forever','trying','vacation', 'beer', 'upload', 'listening', 'mess', 'working', 'light', 'day', 'channel', 'bird','cleaning', 'cell', 'wheres', 'schedule', 'msn', 'folk', 'article', 'milk', 'imagine', 'key', 'darn', 'dnt', 'san', 'making', 'knee', 'clear', 'everyday', 'crack', 'anywhere', 'afford', 'consider', 'floor', 'however', 'somebody', 'expensive', 'secret', 'drag', 'draw', 'quote', 'lake', 'chip', 'unless', 'strong', 'delicious', 'row', 'system', 'crappy', 'workout', 'create',
              'husband', 'blackberry', 'gig', 'goes', 'fam', 'guy', 'allow', 'bro', 'alot', 'whatever', 'roll', 'clothes','theres', 'minutes', 'done','july', 'different', 'safe', 'record', 'lay', 'sort', 'cancel', 'relax', 'thinking', 'stand', 'absolutely','apart', 'cuddle', 'hide', 'mini', 'ily', 'explain', 'j', 'attempt', 'possibly', 'bos', 'nooo', 'war', 'pet', 'sam', 'flower', 'lead', 'option', 'juice', 'spanish', 'table', 'rough', 'handle', 'lookin', 'fault', 'dat', 'public', 'nightmare', 'football', 'hehehe', 'soccer', 'request', 'everyones', 'florida', 'squarespace', 'sport', 'six', 'onto', 'sa', 'hoo', 'heres', 'north', 'winter', 'alex', 'delay', 'truly', 'medium', 'spam','workin', 'wind', 'pro',
              'world', 'could', 'yourselves', 'text', 'august', 'energy', 'ad', 'egg', 'tonite', 'narrative', 'point', 'speak', 'cover', 'shout', 'trailer', 'thru', 'peep', 'wet', 'copy', 'trek', 'friends', 'shift', 'contact', 'woke', 'honey', 'screw', 'drinking' 'spot', 'tune', 'graduate', 'gift', 'jk', 'australia', 'price', 'board', 'south', 'hahahaha', 'fresh', 'match', 'prob', 'bunch', 'cough', 'laundry', 'color', 'degree', 'include', 'feelin', 'anyways', 'sum', 'broken','mix', 'living', 'prepare', 'dry','orange', 'attend', 'boston', 'daily',
              'everyone', 'sequence', 'deliver', 'finale', 'sit', 'assignment', 'spell', 'science', 'social', 'treat','heading', 'fml', 'nearly', 'fat', 'somewhere', 'playing', 'nose', 'child', 'f', 'tweetdeck', 'earlier','ton', 'library','gah', 'hah','whos', 'grrr', 'lord', 'suggestion','sandwich', 'ac', 'bread', 'mostly', 'aunt', 'shitty', 'conference', 'deep', 'tha', 'awhile', 'spent', 'relaxing', 'ms', 'model', 'noooo', 'cupcake', 'net', 'fab', 'network', 'fuckin', 'prefer', 'toast', 'lmfao', 'sarah', 'status', 'otherwise', 'aha', 'os', 'heh', 'abt', 'appear', 'sucks', 'ughh', 'tattoo', 'rent', 'earth', 'meal', 'hoping', 'bowl', 'golf', 'cali', 'allergy', 'macbook', 'anybody', 'gross', 'heck', 'snow', 'contest', 'slightly', 'cable',
              'us', 'weight', 'level', 'exams', 'million', 'america', 'diet', 'getting', 'toe', 'stage', 'dammit','rd', 'fever', 'delete', 'race', 'info', 'blow', 'ring', 'went', 'magic', 'brain', 'lesson', 'manage', 'background', 'possible', 'doubt', 'missing', 'land', 'interest', 'sitting', 'nail', 'bite', 'mark', 'doin', 'starbucks', 'rid', 'middle','cheap',
              'yum', 'taylor', 'gay', 'sooooo', 'daddy', 'eating', 'dang', 'awwww', 'nyc', 'paint', 'album', 'ny','sometime','continue','neck','player','simple', 'cost', 'prayer', 'barely', 'everywhere','program', 'finished', 'somehow', 'hav', 'matt', 'chinese', 'edit', 'found', 'angel', 'harry', 'marry', 'log', 'ahhhh', 'atm',
              'jon', 'series', 'store', 'actually', 'years', 'man', 'im', 'with', 'only', 'is', 'had','rd', 'shut', 'fever', 'delete', 'better', 'race', 'silly', 'info', 'blow', 'ring', 'went', 'magic', 'brain', 'lesson', 'manage', 'background', 'possible', 'doubt', 'missing', 'land', 'interest', 'sitting', 'nail', 'bite', 'mark', 'doin', 'starbucks', 'rid', 'middle',
              ...
              'where', 'can', 'than', 'in', 'sex','memory', 'blood', 'pc', 'nick', 'itunes', 'coz', 'cheese', 'chillin', 'hill', 'mall', 'dunno', 'mail', 'bear', 'def', 'ooh', 'drunk', 'choice', 'heat', 'sky','surgery', 'sir', 'quit', 'across', 'hero', 'pair',
              ...
              'to', 't', 'few', 'put', 'was', 'woo', 'within', 'gang', 'wellacted', 'stir', 'bring', 'soap','aplusk', 'climb', 'wooo', 'wouldve', 'tooo', 'private', 'content', 'bee', 'guest', 'dig',
              ...
              'lmao', 'himself', 'facebook', 'aw', 'fix', 'asleep', 'her', 'such', 'have', 'yours', 'for','things', 'gear', 'infection', 'msg', 'palm', 'noise', 'several', 'geek', 'wild', 'exist', 'spain', 'iron', 'bomb', 'zoo', 'toronto', 'suddenly', 'umm', 'bean', 'took', 'steve', 'per', 'buck', 'river', 'stock', 'headed', 'whoa', 'skype',
              ...
              'l', 'timing', 'pink', 'audience', 'viewer', 'search', 'get', 'toward', 'gettin', 'ouch', 'bum', 'cousin','curl', 'prince', 'gona', 'wood', 'thurs', 'dancing', 'woah', 'singapore', 'sry', 'zone', 'popular', 'curse', 'edward', 'teen', 'sundays', 'eventually', 'url', 'sniff', 'sooner', 'jeff', 'meant', 'bein', 'theory', 'paranoid', 'jet', 'license', 'ups', 'se', 'moving', 'bleh', 'writer', 'cmon', 'amanda', 'rt', 'errand', 'microsoft', 'havnt', 'dye', 'blind', 'lvatt', 'gun', 'tomato', 'ban', 'blonde', 'demo', 'function', 'roof', 'wallet', 'andrew', 'tap', 'shave', 'grandpa', 'muffin', 'layout', 'photoshop', 'split', 'bros', 'hall', 'nighty', 'podcast', 'grace', 'subway', 'thatll', 'hire', 'woop', 'diego', 'headphone', 'windy', 'spare', 'zombie', 'tryna', 'mah', 'planet', 'rachel', 'panda', 'hooray', 'tease', 'police', 'hee', 'destroy', 'transformer', 'university', 'spill', 'rescue', 'drum', 'tgif', 'photography', 'yahoo', 'hangin', 'kirstiealley', 'cod', 'bummed', 'knight', 'officialtila', 'amazon', 'sweetheart', 'security', 'lemon', 'sheet','oven', 'pe', 'loop', 'dope', 'dust', 'holla', 'toooo', 'pit', 'eatin', 'poem', 'geography', 'sub', 'tweeple', 'frozen', 'recital', 'pin', 'hike', 'vista', 'helpful', 'vibe', 'kimkardashian', 'dump', 'mental', 'nj', 'pregnant', 'thomas', 'marley', 'dannygokey', 'friggin', 'eminem', 'argentina', 'whoo', 'sucky', 'society', 'bracelet', 'torture', 'nc', 'asshole', 'therealjordin', 'whoever', 'upon', 'aussie', 'march', 'voting', 'flow', 'organize', 'pix', 'grateful', 'pleased', 'favor', 'nerve', 'precious', 'te', 'hood', 'advance', 'swollen', 'gots',
              'uk', 'stomach', 'shoe', 'google', 'their', 'yall', 'fb', 'team', 'flu', 'thx', 'wtf', 'voice','esp', 'fri', 'central', 'bing', 'universe', 'jerk', 'tank', 'coach', 'duck','coursework', 'meee', 'seven', 'tube', 'mrs', 'swing', 'takin', 'tape', 'reunion', 'waitin', 'owe', 'sudden', 'tbh', 'itchy', 'judge', 'disneyland', 'youuu','wk', 'digital', 'hv', 'amuse', 'ohhhh', 'neighbour', 'jen', 'appt', 'turkey', 'alexalltimelow', 'alas', 'dick', 'lisa','heal', 'rainbow', 'talking', 'megan', 'following', 'bleed', 'fl', 'remain', 'divorce', 'afterwards', 'finals', 'gnite', 'tracecyrus', 'awkward', 'fo', 'wth', 'playlist', 'michelle', 'mag', 'yer', 'flag', 'information', 'shiny','nxt', 'jake', 'blanket', 'stair', 'ahah', 'deadline', 'fawcett', 'scott', 'robin', 'exact', 'legs', 'twitters', 'sunglass', 'santa', 'smith', 'learning', 'ellen', 'tues', 'veggie', 'unable', 'tall', 'jim', 'married', 'cartoon', 'steph', 'tx', 'heap', 'asot', 'bowling', 'sob', 'plate', 'gal', 'pete', 'map', 'reaction', 'recent', 'wknd', 'willing', 'coldplay', 'papa', 'thai', 'stranger', 'waking', 'reader', 'approve', 'norway', 'develop', 'concern', 'irish', 'kristen', 'slide', 'raw', 'forecast',
              'finger', 'mtv', 'math', 'followfriday', 'yep', 'download', 'bye', 'rain', 'about', 'between', 'wan','flickr','october', 'hahahah', 'previous', 'wanted', 'cheat', 'source', 'cricket', 'transformers', 'comedy', 'borrow', 'theatre', 'cab', 'location', 'require', 'dam', 'jst', 'kids', 'rove', 'pocket', 'useful', 'morn','rockin', 'charlie', 'bak', 'owner', 'definately', 'greek', 'insurance', 'ran', 'hater', 'mmmmm', 'pissed', 'youth', 'solo', 'zero', 'ull', 'iamdiddy', 'trending', 'whoop', 'ga', 'addiction', 'crawl', 'lem', 'wrist', 'gmail', 'ne', 'kobe', 'emma', 'homemade', 'carpet', 'role', 'brace', 'hmmmm', 'parking', 'wise', 'dun', 'ooooh', 'xp', 'porn', 'accent', 'twittering', 'mummy', 'exchange', 'jamie', 'mow', 'wossy', 'buzz', 'shoutout', 'gone', 'ash', 'aye', 'rat', 'speaker', 'dads', 'budget', 'geez', 'ashleytisdale', 'indian', 'skate', 'flood', 'sync', 'whore', 'demand', 'solve', 'oz', 'hiya', 'twitterland', 'metal', 'sooooooo', 'guide', 'tmr', 'lilyroseallen', 'cutie', 'rap', 'impressed', 'backup', 'shade', 'charm', 'slice', 'sec', 'speaking', 'doggy', 'dull', 'bastard', 'trash', 'resist', 'wrk', 'natural', 'shortly', 'joey', 'adore', 'slip', 'brush','unfollow', 'ds', 'premiere', 'promote', 'intense', 'ohio', 'celebration', 'temp', 'bride', 'anna','hp',
              'hug', 'season', 'tweet', 'hey', 'weekend', 'that', 'once', 'does', 'shall', 've','save', 'drop', 'answer','staff', 'grrrr', 'lounge', 'shed','asian', 'wordpress', 'poop', 'vampire', 'prove', 'dd', 'wireless', 'musicmonday', 'waffle', 'sneeze', 'logo', 'comfort', 'opening', 'express', 'gud', 'vodka', 'brian', 'lang', 'obsess', 'medicine', 'tidy', 'soft', 'hon', 'laura', 'browser', 'bridge', 'bella', 'stephenfry', 'cu', 'snuggle', 'billy',  'lap', 'nicole', 'audio', 'nurse', 'drain', 'somethin', 'biology', 'lb', 'emotional', 'sayin', 'ahhhhh', 'bass', 'maintenance', 'towards', 'semester', 'tempt', 'nicely', 'wars', 'ummm', 'selena', 'plain', 'leak', 'yayy', 'din', 'sausage', 'cow', 'fyi', 'nba', 'envy', 'tee', 'typical', 'task', 'thingy', 'kyle', 'smash','personally', 'dannywood', 'boom', 'andyclemmensen', 'wa', 'johncmayer', 'giggle', 'jones', 'supernatural', 'position', 'inch', 'discuss', 'prize', 'thee', 'yayyy', 'nadal', 'theyd', 'pathetic', 'christian', 'denver', 'phew', 'obama', 'lo', 'grandparent', 'male', 'pup', 'blister', 'easter', 'cycle', 'gg', 'weed', 'blogging', 'jazz', 'belong', 'grind', 'farm', 'physic', 'signal', 'un', 'army', 'username', 'highlight', 'display', 'sleepover', 'patient', 'wud', 'accord', 'explode', 'updated', 'downstairs', 'chore', 'lebron', 'solution', 'skinny', 'refer', 'daniel', 'curry', 'twitterer', 'minus', 'reference', 'transfer', 'thousand',
...
#
# word_len = []
# for file in ['/home/john/geek_stuff/Data_Set/cornel_sentiment_data_set/rt-polaritydata/rt-polarity.pos', '/home/john/geek_stuff/Data_Set/cornel_sentiment_data_set/rt-polaritydata/rt-polarity.neg']:
...
# print('Most freq word len ', mode(word_len))
# print('wordlen Max {0}, Min {1}'.format(max(word_len), min(word_len)))
...
# with open('/home/john/sentiment_files/data/cornel_univ_movie_data/cornel_univ_movie_vocab.pkl', 'wb') as f:
...
for file in ['/home/john/geek_stuff/Data_Set/cornel_sentiment_data_set/rt-polaritydata/rt-polarity.pos']:
    with open(file, 'r', encoding='latin-1') as f:
        for data in f:
            print(data)
            # if idx % 10000 == 0:
            ...
            print([each_word for each_word in lemmatized_data if each_word in frequent_words])
            truncated_review = []
...
print('Input data shape ', input_data.shape)
print('Target data shape ', target_data.shape)
data_sample = input_data.shape[0]
print('Train Sample ', int(data_sample*0.81))
train_dict = {'input': input_data[:int(data_sample*0.81)], 'target': target_data[:int(data_sample*0.81)]}

print('Train input Shape {0}, train target shape {1}'.format(input_data[:int(data_sample*0.81)].shape, target_data[:int(data_sample*0.81)].shape))

print('Validation Dict from {0} to {1}'.format(int(data_sample*0.81), int(data_sample*0.9)))

val_dict = {'input': input_data[int(data_sample*0.81): int(data_sample*0.9)], 'target': target_data[int(data_sample*0.81): int(data_sample*0.9)]}

print('test Dict from {0} to {1}'.format(int(data_sample*0.9), data_sample))

test_dict = {'input': input_data[int(data_sample*0.9):], 'target': target_data[int(data_sample*0.9):]}

print('Test input Shape {0}, test target shape {1}'.format(input_data[int(data_sample*0.9):].shape, target_data[int(data_sample*0.9):].shape))

with open('/home/john/sentiment_files/data/cornel_univ_movie_data/train_pos.pkl', 'wb') as f:
    pickle.dump(train_dict, f)

with open('/home/john/sentiment_files/data/cornel_univ_movie_data/validation_pos.pkl', 'wb') as f:
    pickle.dump(val_dict, f)

with open('/home/john/sentiment_files/data/cornel_univ_movie_data/test_pos.pkl', 'wb') as f:
    pickle.dump(test_dict, f)
# train_dict = {'input': input_data, 'target': target_data}
#
# with open('/home/john/sentiment_files/data/cornel_univ_movie_data/twitter_last.pkl', 'wb') as f:
#     pickle.dump(train_dict, f)